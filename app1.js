...
function exportBackup() {
  ...
  download(`backup-Aguiarhub-oliveira-${toDateInput(new Date())}.json`, JSON.stringify(backup, null, 2), "application/json;charset=utf-8");
